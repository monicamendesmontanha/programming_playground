...
// Synchronous
// const fileData = fs.readFileSync('flinststones.txt', 'utf-8');  // blocking
// console.log(fileData)

// Asynchronous IO
// Better efficiency because it's non-blocking.
// Error first pattern:
// Callbacks functions in Node.js usually get:
//  1. error param (null if no error occurred)
//  2. data param
fs.readFile('flinststones.txt', 'utf-8', function (error, data) {
  if (error) {
